...
export const asignarActivosValidation = Joi.object({
    ...
    sede_id: Joi.number()
        ...
        .required()
        .messages({
            "number.base": "El id de la sede debe ser un numero.",
            "number.positive": "El id de la sede debe ser un numero positivo.",
            "any.required": "El id de la sede es obligatorio."
        }),
